    ...
    public function destroy(Request $request)
{
    ...
    // Clear the cache
    Cache::forget("tasks_user_" . Auth::id() . "_completed");
    ...
    {
        $userId = Auth::id();
        $completedTodos = Cache::remember("tasks_user_{$userId}_completed", 60, function () use ($userId) {
            return Task::where('user_id', $userId)->where('completed', true)->get();
        });
        return view('Task.completed', compact('completedTodos'));
    }
